...
const appCss = "/assets/styles-oKoWF4O1.css";
...
const logo$1 = "/assets/logo1-D42WA_8d.png";
const navLinks = [
  { to: "/", label: "Home" },
...
function Header() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.header,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "group flex items-center gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col leading-none", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base font-bold tracking-tight text-primary", children: "AIB" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-semibold uppercase tracking-[0.2em] text-muted-foreground", children: "Communications" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden items-center gap-6 lg:flex", children: navLinks.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            Link,
            {
              to: l.to,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setOpen(!open), className: "rounded-md p-2 lg:hidden", "aria-label": "Menu", children: open ? /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "h-5 w-5" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Menu, { className: "h-5 w-5" }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: open && /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1 px-4 py-3", children: [
              navLinks.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: l.to, onClick: () => setOpen(false), className: "rounded-lg px-3 py-2.5 text-sm font-semibold hover:bg-muted", children: l.label }, l.to)),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "tel:8884776212", className: "mt-2 inline-flex items-center justify-center gap-2 rounded-full bg-primary px-5 py-3 text-sm font-semibold text-primary-foreground", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "h-4 w-4" }),
                " (888) 477-6212"
              ] })
            ] })
...
const logo = "/assets/logo-htek-CR3YGQR0.png";
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "mt-24", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-gradient-hero text-primary-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-10 md:grid-cols-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logo, alt: "AIB Communications", className: "h-14 w-14 object-contain" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-lg font-bold", children: "AIB Communications" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] uppercase tracking-[0.2em] text-primary-foreground/70", children: "Services LLC" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm leading-relaxed text-primary-foreground/85", children: "Authorized agent and reseller for the leading Internet & TV providers, delivering seamless connectivity to your doorstep." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "mb-3 text-sm font-bold uppercase tracking-wider text-yellow", children: "Contact" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "tel:8884776212", className: "mb-2 flex items-center gap-2 text-sm hover:text-yellow", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "h-4 w-4" }),
          " (888) 477-6212"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "mailto:Support@aibcommunications.com", className: "mb-2 flex items-center gap-2 text-sm hover:text-yellow", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "h-4 w-4" }),
          " Support@aibcommunications.com"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "flex items-start gap-2 text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "mt-0.5 h-4 w-4 shrink-0" }),
          " 9801 Westheimer Rd Ste 205-10, Houston, TX 77042"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "mb-3 text-sm font-bold uppercase tracking-wider text-yellow", children: "Disclaimer" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs leading-relaxed text-primary-foreground/75", children: "AIB Communications is an authorized reseller / agent. All offers are subject to change and availability in your area. Pricing, channels, and speeds may vary by location." })
      ] })
    ] }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-footer", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 px-4 py-6 text-xs text-muted-foreground sm:px-6 md:flex-row lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "© ",
        (/* @__PURE__ */ new Date()).getFullYear(),
        " AIB Communications. All rights reserved."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/terms", className: "hover:text-pink", children: "Terms" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/privacy", className: "hover:text-pink", children: "Privacy" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/ccpa", className: "hover:text-pink", children: "California" })
      ] })
    ] }) })
  ] });
}
...
const $$splitComponentImporter$6 = () => import("./terms-DlxxP9S9.js");
const Route$6 = createFileRoute("/terms")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Terms and conditions for use of the AIB Communications website."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./services-c8oFtGbV.js");
const Route$5 = createFileRoute("/services")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Internet, Cable TV, and 24/7 customer support from AIB Communications. Authorized partner of Optimum, Frontier, EarthLink, DirecTV, and Kinetic."
    }, {
      property: "og:title",
      content: "Services — AIB Communications"
    }, {
      property: "og:description",
      content: "High-speed internet & cable TV delivered to your doorstep."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./privacy-2zzwy62Q.js");
const Route$4 = createFileRoute("/privacy")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "How AIB Communications collects, uses, and shares personal information."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./contact-CbNwXrPC.js");
const Route$3 = createFileRoute("/contact")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Get in touch with AIB Communications. Our team is available 24/7 for internet and TV support, quotes, and new installations."
    }, {
      property: "og:title",
      content: "Contact AIB Communications"
    }, {
      property: "og:description",
      content: "Feel free to contact us anytime — we're here 24/7."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./ccpa-CR3K5sRV.js");
const Route$2 = createFileRoute("/ccpa")({
  head: () => ({
    meta: [{
      title: "California Privacy Rights — AIB Communications"
    }, {
      name: "description",
      content: "Your California Privacy Rights and CCPA disclosures from AIB Communications."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./about-C_yP72L8.js");
const Route$1 = createFileRoute("/about")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "AIB Communications is on a mission to revolutionize your internet experience with cutting-edge connectivity from the providers you trust."
    }, {
      property: "og:title",
      content: "About AIB Communications"
    }, {
      property: "og:description",
      content: "A connected world where seamless internet empowers individuals and businesses."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-BcPG9Xeo.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Get the fastest internet, TV, mobile and home security deals from top US providers. Call (888) 477-6212."
    }, {
      property: "og:title",
      content: "AIB Communications — Best Home Service Deals"
    }, {
      property: "og:description",
      content: "Top US providers, transparent pricing, no hidden fees."
    }]
  }),
...
const CcpaRoute = Route$2.update({
  id: "/ccpa",
  path: "/ccpa",
  getParentRoute: () => Route$7
});
